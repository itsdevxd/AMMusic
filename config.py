...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "dev ᴍᴜsɪᴄ")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/itsdevxd/AMMusic")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Tfcbots")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/TheFriendsChatting")
